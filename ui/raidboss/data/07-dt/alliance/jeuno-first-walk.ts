  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Ark Angel MR': 'Ark Angel MR',
        'Ark Angel TT': 'Ark Angel TT',
        'Castle Zvahl Keep': 'ズヴァール城内郭',
        'Despot': 'Despot',
        'Fafnir The Forgotten': '忘れられたファフニール',
        'Fafnir the Forgotten': '忘れられたファフニール',
        'lordly shadow': '闇の王の幻影',
        'Lordly Shadow': '闇の王の幻影',
        'luminous remnant': '輝く残滓',
        'Luminous Remnant': '輝く残滓',
        'Prishe Of The Distant Chains': '束縛のプリッシュ',
        'Prishe of the Distant Chains': '束縛のプリッシュ',
        'Ru\'Aun Gardens': 'ル・アオンの庭',
        'Shadow Lord': '闇の王',
        'Sprinkler': 'Sprinkler',
        'The Boyahda Tree': 'ボヤーダ樹',
        'The Dragon\'s Aery': '龍の巣',
      },
      'replaceText': {
        '--all untargetable--': '--全体ターゲット不可--',
        '--Binding Indicator': '--バインド予兆--',
        '--Darters spawn--': '--ダーター出現--',
        '--EV \\+ HM center--': '--EV + HM 中央移動--',
        '--EV \\+ HM targetable--': '--EV + HM ターゲット可能--',
        '--EV untargetable--': '--EV ターゲット不可--',
        '--GK targetable--': '--GK ターゲット可能--',
        '--HM center--': '--HM 中央移動--',
        '--MR center--': '--MR 中央移動--',
        '--MR jump--': '--MR ジャンプ--',
        '--MR targetable--': '--MR ターゲット可能--',
        '--TT jump--': '--TT ジャンプ--',
        '\\(add\\)': '(雑魚)',
        '\\(big raidwide\\)': '(大全体攻撃)',
        '\\(boss\\)': '(ボス)',
