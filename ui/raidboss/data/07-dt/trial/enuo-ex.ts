  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        '\\(lines\\)': '(直線)',
        '\\(puddles\\)': '(設置AoE)',
        '\\(puddle baits \\+ pyretic\\)': '(AoE誘導 + 熱放射)',
        '\\(puddle explodes\\)': '(AoE爆発)',
        '\\(spread\\)': '(散開)',
        'Airy Emptiness': '拡散波動',
        'All for Naught': '無の領域',
        'Almagest': 'アルマゲスト',
